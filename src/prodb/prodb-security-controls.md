...
**重要:** システム側では強制的にセッションCookieを再作成させることができません。変更後、ユーザーにサインアウトさせる必要がある。{.tip}


<img src="/img/figure-prodb-security-controls-screen.png" width="100%" alt="図: PROdb Security Controls 画面">
